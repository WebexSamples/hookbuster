 ...
 */
var StatsError = function (_extendableBuiltin2) {
  (0, _inherits3.default)(StatsError, _extendableBuiltin2);
  ...
  */
  function StatsError() {
    ...
    (0, _classCallCheck3.default)(this, StatsError);

    var _this = (0, _possibleConstructorReturn3.default)(this, (StatsError.__proto__ || (0, _getPrototypeOf2.default)(StatsError)).call(this, message));
